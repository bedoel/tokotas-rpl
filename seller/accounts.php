                                    ...
                                    <tbody>
                                        <?php foreach ($users as $user) : ?>
                                            <tr>
                                                ...
                                                <td><span class="font-medium text-warna"><?= $user['id_user']; ?></span></td>
                                                <td class="txt-oflo text-warna"><?= $user['name']; ?></td>
                                                <td><span class="font-medium text-warna"><?= $user['username']; ?></span></td>
                                                <?php if ($user['role'] == "Admin") : ?>
                                                    <td><span class="label label-info label-rounded"><?= $user['role']; ?></span> </td>
                                                <?php else : ?>
                                                    <td><span class="label label-success label-rounded"><?= $user['role']; ?></span> </td>
                                                <?php endif; ?>
                                                <td class="txt-oflo text-warna"><?= $user['email']; ?></td>
                                                <td class="txt-oflo text-warna"><?= $user['no_telp']; ?></td>
                                                <td class="txt-oflo text-warna"><?= $user['tgl_lahir']; ?></td>
                                                <td class="txt-oflo text-warna"><?= $user['password']; ?></td>
                                                <td class="txt-oflo text-warna"><a href="edit.php?id=<?= $user['id_user']; ?>">Edit</a> | <a href="delete.php?id=<?= $user['id_user']; ?>" onclick="
