...
$orders = query("SELECT transaksi.*, barang.*, tbl_users.*
FROM transaksi
INNER JOIN tbl_users ON transaksi.id_user = tbl_users.id_user
INNER JOIN barang ON transaksi.kd_barang = barang.kd_barang WHERE barang.id_user = $id_user
");
$count = 1;
                                    ...
                                    <tbody>
                                        <?php foreach ($orders as $order) : ?>
                                            <tr>
                                                ...
                                                <td class="txt-oflo"><img src="../img/<?= $order['gambar_barang']; ?>" alt="" width="100"></td>
                                                <td><span class="font-medium"><?= $order['id_transaksi']; ?></span></td>
                                                <td class="txt-oflo"><?= $order['nama_barang']; ?></td>
                                                <td class="txt-oflo"><?= $order['name']; ?></td>
                                                <td><span class="font-medium"><?= $order['username']; ?></span></td>
                                                <td class="txt-oflo"><?= $order['email']; ?></td>
                                                <td class="txt-oflo"><?= $order['no_telp']; ?></td>
                                                <td class="txt-oflo"><?= $order['tgl_transaksi']; ?></td>
                                                <td class="txt-oflo"><?= $order['jml_barang']; ?></td>
                                                <td class="txt-oflo">Rp<?= number_format($order['total_harga']); ?></td>
                                                <td class="txt-oflo"><?= $order['tujuan']; ?></td>
                                                <td class="txt-oflo text-warna"><a href="edit-order.php?id=<?= $order['id_transaksi']; ?>">Edit</a> | <a href="delete-order.php?id=<?= $order['id_transaksi']; ?>" onclick="
