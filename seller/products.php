...
if (isset($_SESSION["id"])) {
    ...
    $products = query("SELECT * FROM barang WHERE id_user = '$id_user'");
    $count = 1;
}
                    ...
                    <div class="navbar-brand">
                        <a href="index.php" class="logo">
                            ...
                            <b class="logo-icon">
                                ...
                                <!-- Dark Logo icon -->
                                <!-- Light Logo icon -->
                                <img src="assets/images/LOGOTT.svg" alt="homepage" class="light-logo" width="30" />
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
                        ...
                        <div class="card">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-dark">
                                    <thead>
                                        <tr class="table-dark">
                                            <th class="text-warna">NO</th>
                                            <th class="text-warna">GAMBAR</th>
                                            <th class="text-warna">KODE BARANG</th>
                                            <th class="text-warna">NAMA</th>
                                            <th class="text-warna">HARGA</th>
                                            <th class="text-warna">STOK</th>
                                            <th class="text-warna">KATEGORI</th>
                                            <th class="text-warna">AKSI</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php foreach ($products as $product) : ?>
                                            <tr>
                                                <td class="txt-oflo text-warna"><?= $count; ?></td>
                                                <td class="txt-oflo text-warna"><img src="../img/<?= $product['gambar_barang']; ?>" alt="" width="100"></td>
                                                <td><span class="font-medium text-warna"><?= $product['kd_barang']; ?></span></td>
                                                <td class="txt-oflo text-warna"><?= $product['nama_barang']; ?></td>
                                                <td><span class="font-medium text-warna">Rp<?= number_format($product['harga_barang']); ?></span></td>
                                                <td class="txt-oflo text-warna"><?= $product['stok_barang']; ?></td>
                                                <td class="txt-oflo text-warna"><?= $product['kategori']; ?></td>
                                                <td class="txt-oflo text-warna"><a href="edit-product.php?id=<?= $product['kd_barang']; ?>">Edit</a> | <a href="delete-product.php?id=<?= $product['kd_barang']; ?>" onclick="
                                    return confirm('Apakah Anda yakin ingin menghapus?')">Hapus</a></td>
                                            </tr>
                                            <?php $count++; ?>
                                        <?php endforeach; ?>
                                    </tbody>
